...
- the app uses the CRUD operations (create, read, update, delete), and save expenses to localstorage
and retrives them on startup if they exist in localstorage

create: clicking + button to create new expense
read: available expenses will be read and displayed on homepage screen
